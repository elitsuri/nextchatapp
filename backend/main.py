"""
nextchatapp - Backend API
NextChatApp: Real-time chat with Next.js App Router, WebSockets, and auth
"""
...
app = FastAPI(
    title="nextchatapp",
    description="NextChatApp: Real-time chat with Next.js App Router, WebSockets, and auth",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "nextchatapp"}
